  ...
  return (
    <section className="home-hero">
      <div className="container home-hero__content">
        ...
        <Link href="/products" className="btn btn-primary home-hero__cta">
          {t("home.hero.cta")}
    ...
    <section className="home-features">
      <div className="container">
        <div className={`reveal ${visible ? "is-visible" : ""}`} ref={ref}>
          <p className="home-features__eyebrow">
...
const SUBSCRIPTIONS = [
  { id: "weekly", img: "/images/sub_week.png" },
  { id: "rental", img: "/images/sub_rent.png" },
];
...
function SubscriptionSection() {
  ...
  return (
    <section
      className="home-subs"
      style={{ backgroundImage: "url('/images/sub_bg.png')" }}
    >
    ...
    <section className="home-featured">
      <div className="container">
              ...
              <div className="col-sm-6 col-lg-3" key={p.id}>
                ...
                >
                  ...
                  <div className="home-featured__card__body">
                    <p className="home-featured__card__name">
        ...
        <div className="text-center mt-5">
          <Link href="/products" className="btn btn-outline-primary px-4">
...
function ContactSection() {
  ...
  const mapSrc = `${MAP_SRC_BASE}&hl=${locale}`;
